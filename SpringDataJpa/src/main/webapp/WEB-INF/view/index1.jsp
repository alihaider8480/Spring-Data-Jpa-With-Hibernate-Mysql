...
<div align="center"  style=" border: dotted; padding-left: 1ex; color: green;">
   ...
   <br><br>
      <form action="${pageContext.request.contextPath}/User/ShowUserRecordsSortByName" method="post">
       <table style="border: 1ex 1ex" bordercolor="Black">
        <tr>
         <th>
         <input type="submit" value="Show All Records Sort By Name" >
         </th>
        </tr>
       </table>
     </form> 
     ...
     <br><br>
      <form action="${pageContext.request.contextPath}/User/ShowUserRecordsSortByNameGetMethods" method="get">
             <table style="border: 1ex 1ex" bordercolor="Black">
        <tr>
         <th>
         <input type="submit" value="Show All Records Sort By Name And Pagination" >
         </th>
        </tr>
       </table>
     </form> 
...
<br><br>
     <form:form action="${pageContext.request.contextPath}/User/FindStudentNameWithPagination" method="Post" modelAttribute="findp">
<h1>Find by name With Pagination</h1>
   ${find}<br>
 <table style="border: 1ex 1ex" bordercolor="Black">
  <tr>
    <td>Name<br>
